...
function bluemixminimal_install() {
  include_once DRUPAL_ROOT . '/profiles/minimal/minimal.install';
  minimal_install();
}

function bluemixminimal_install_tasks_alter(&$tasks, $install_state) { 
  $tasks['install_settings_form']['function'] = 'bluemixminimal_install_settings_form';
}
 
function bluemixminimal_install_settings_form($form, &$form_state, &$install_state) {
  global $databases;
...
// I Edited this line, to point to our custom submit function.
    '#submit' => array('bluemixminimal_install_settings_form_submit'),
  );
...
function bluemixminimal_install_settings_form_validate($form, &$form_state) {
...
function bluemixminimal_install_settings_form_submit($form, &$form_state) {
